...
export default function LoginScreen() {
  ...
  const handleAuth = async () => {
    ...
    setLoading(true);
    // Formatage international strict pour Twilio/Django
    ...
    try {
      ...
      if (result.ok) {
        // On navigue vers l'écran de confirmation en passant le numéro
        navigation.navigate('CodeConfirmation', { phoneNumber: fullPhoneNumber });
      } else {
        // Gestion de l'erreur retournée par l'API (ex: numéro mal formé)
