...
// Corps du texte légal (CGU), identique entre l'écran d'acceptation
// (TermsAndConditions.js) et le lecteur en lecture seule (CUG.js). La ligne
// "Date de mise à jour" reste dupliquée dans chaque écran plutôt que
// partagée ici, car son emplacement diffère légèrement entre les deux mises
// en page (voir les deux écrans pour le détail).
export default function LegalTermsBody() {
  return (
    <>
